...
public class A0505DaoImp extends CommonDaoImp implements A0505Dao{
	...
	@Override
	public List<Userlogin> selectByAll() {
		List<Userlogin> dataList = new ArrayList<Userlogin>();
		Connection conn = null;
		PreparedStatement pstmt  = null;
		ResultSet rs = null;
	...
	@Override
	public int freezeUser(Integer paraId) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int affectRow = 0;
		conn = dbUtils.getConn();
	...
	@Override
	public int unfreezeUser(Integer paraId) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int affectRow = 0;
		conn = dbUtils.getConn();
